...
namespace PSI_Interface.IdentData.IdentDataObjs
{
    ...
    public class ProteinDetectionListObj : ParamGroupObj, IIdentifiableType, IEquatable<ProteinDetectionListObj>
    {
        ...
        {
            return other is ProteinDetectionListObj o && Equals(o);
        }
        ...
        public bool Equals(ProteinDetectionListObj other)
        {
            ...
            return Name == other.Name && Equals(ProteinAmbiguityGroups, other.ProteinAmbiguityGroups) &&
                   ParamsEquals(other);
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                hashCode = (hashCode * 397) ^ (ProteinAmbiguityGroups?.GetHashCode() ?? 0);
