...
namespace PSI_Interface.IdentData.mzIdentML
{
    ...
    internal static class Extensions
    {
        ...
        /// <param name="items">source list/IEnumerable. If a list, the target list will have capacity changed to allow adding all of the items in this list without further reallocations.</param>
